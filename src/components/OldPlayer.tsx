...
const Player: React.FC<PlayerProps> = ({ track }) => {
  ...
  return (
    <div className="w-80 flex flex-col items-center justify-between bg-neutral-400">
      <div className="pt-1 text-xl text-">{track.title}</div>
      <div className="pt-1 text-sm">{track.artist}</div>
