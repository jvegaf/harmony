			...
			try {
				...
				if (data) {
					...
					if (tracks && tracks.length > 0) {
						logger.info(
							`[Sidebar] Dropped ${tracks.length} tracks onto playlist ${playlistId}`,
						);
						playlistsAPI
			...
			content = (
				...
				>
					<span className={styles.navLabel}>
						<IconMusic size={16} className={styles.navIcon} />
						{elem.name}
					</span>
				</button>
			);
	...
	return (
		<aside className={styles.sidebar}>
			...
			<nav className={styles.nav}>
				...
				>
					<span className={styles.navLabel}>
						<IconVinyl size={16} className={styles.navIcon} />
						Collection
					</span>
				</button>
				<button
				...
				>
					<span className={styles.navLabel}>
						<IconClock size={16} className={styles.navIcon} />
						Recently Added
					</span>
				</button>
			</nav>
