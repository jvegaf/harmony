...
> = set => ({
  ...
  setUser: user => set({ user, isAuthenticated: true }, undefined, 'user/setUser'),

  logout: () => set({ user: null, isAuthenticated: false }, undefined, 'user/logout'),
});
...
> = set => ({
  ...
  clearNotifications: () => set({ notifications: 0, messages: [] }, undefined, 'notifications/clear'),
});
